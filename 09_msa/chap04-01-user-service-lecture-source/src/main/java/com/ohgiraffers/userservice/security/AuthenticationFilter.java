...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    /* 설명. 로그인 시도 시 동작하는 기능(POST방식의 /login 요청) -> request Body에 담겨 온다. (꺼내 쓸수 없기에, stream 활용) */
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        /* 설명. DB를 다녀와 사용자의 고유 아이디(userId)를 가져올 예정(Pricipal 객체(Authentication)에는 없는 값이므로) */
